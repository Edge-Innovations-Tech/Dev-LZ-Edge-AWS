...
VPC, private subnets, isolated data subnets, controlled egress, and endpoint-ready routing.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Network resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Network landing-zone capability. | `any` | `{}` | no |
