...
RDS/Aurora baseline with no public access, encryption, subnet groups, and backup policy.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Database resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Database landing-zone capability. | `any` | `{}` | no |
