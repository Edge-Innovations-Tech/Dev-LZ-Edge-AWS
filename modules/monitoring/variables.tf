variable "name_prefix" {
  description = "Name prefix for Cortex AWS Monitoring resources."
  type        = string
  default     = "cortex-dev"
}
...
variable "service_config" {
  description = "Provider-specific service configuration for the Monitoring landing-zone capability."
  type        = any
  default     = {}
}
