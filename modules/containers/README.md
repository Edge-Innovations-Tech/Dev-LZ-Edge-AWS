...
Private EKS baseline with restricted endpoint access and workload identity via IRSA.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Containers resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Containers landing-zone capability. | `any` | `{}` | no |
