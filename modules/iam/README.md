...
IAM roles, permission boundaries, GitHub OIDC trust, and least-privilege policy sets.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Iam resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Iam landing-zone capability. | `any` | `{}` | no |
