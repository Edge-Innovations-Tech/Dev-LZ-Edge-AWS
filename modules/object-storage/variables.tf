variable "name_prefix" {
  description = "Name prefix for Cortex AWS Object Storage resources."
  type        = string
  default     = "cortex-dev"
}
...
variable "service_config" {
  description = "Provider-specific service configuration for the Object Storage landing-zone capability."
  type        = any
  default     = {}
}
