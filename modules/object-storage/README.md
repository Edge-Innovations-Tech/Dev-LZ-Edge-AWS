...
S3 buckets with block-public-access, versioning, encryption, and lifecycle policy.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Object Storage resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Object Storage landing-zone capability. | `any` | `{}` | no |
