...
EC2 and Auto Scaling launch patterns with IMDSv2, encryption, and private subnets.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Name prefix for Cortex AWS Compute resources. | `string` | `"cortex-dev"` | no |
...
| <a name="input_service_config"></a> [service\_config](#input\_service\_config) | Provider-specific service configuration for the Compute landing-zone capability. | `any` | `{}` | no |
